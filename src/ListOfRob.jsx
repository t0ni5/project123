  ...
  return (
    <div>
      ...
      <Card
        pathname="/James"
        photo={rob1_phs}
        name={robbers.robbers[0].name}
        years={robbers.robbers[0].years}
        rob_i={0}
      />
      <Card
        pathname="/Cassidy"
        photo={rob2_phs}
        name={robbers.robbers[1].name}
        years={robbers.robbers[1].years}
        rob_i={1}
      />
      <Card
        pathname="/Dillinger"
        photo={rob3_phs}
        name={robbers.robbers[2].name}
        years={robbers.robbers[2].years}
        rob_i={2}
      />
      <Card
        pathname="/Gillis"
        photo={rob4_phs}
        name={robbers.robbers[3].name}
        years={robbers.robbers[3].years}
        rob_i={3}
      />
      <Card
        pathname="/Kid"
        photo={rob5_phs}
        name={robbers.robbers[4].name}
        years={robbers.robbers[4].years}
        rob_i={4}
      />
      <Footer />
    </div>
